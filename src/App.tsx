...
function App() {
    ...
    const handleUpdateTask = (taskId: string, updates: Partial<Task>) => {
        ...
        // Lock existing session durations: do not auto-resize sessions when task time changes
        // Regeneration below will add/remove future sessions as needed while preserving existing ones
